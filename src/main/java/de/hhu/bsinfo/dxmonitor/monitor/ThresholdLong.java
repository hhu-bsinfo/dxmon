...
/**
 * A threshold defined by a long value with an installed callback
 *
 * @author Stefan Nothaas, stefan.nothaas@hhu.de, 20.02.2018
 */
public class ThresholdLong {
    /**
    ...
    public interface CallbackFunction {
         ...
         */
        void handle(final long p_currentValue, final ThresholdLong p_threshold);
    }
     ...
     */
    public ThresholdLong(final String p_name, final long p_value, final boolean p_exceed,
     ...
     */
    public void evaluate(final long p_other) {
